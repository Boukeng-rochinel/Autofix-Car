...
class AppColors {
  ...
  static const Color secondaryColor = Color(
    0xFF007BFF,
  ); // Same as primary for download button
  ...
  static const Color greyButtonColor = Color(
    0xFFE0E0E0,
  ); // Light grey for scan again button
  // static const Color lightGrey = Color(0xFFF0F0F0); // Very light grey for placeholders
  static const Color backgroundColor = Color(
    0xFFF5F5F5,
  ); // Light grey background
  static const Color white = Color(0xFFFFFFFF); // White for contrast
  static const Color textColor = Color(
    0xFF212121,
  ); // Dark grey/black for general text
  static const Color greyTextColor = Color(
    0xFF757575,
  ); // Lighter grey for secondary text
  static const Color lightGrey = Color(
    0xFFEEEEEE,
  ); // Very light grey for backgrounds/borders
  static const Color dividerColor = Color.fromARGB(255, 172, 172, 172);
  ...
  static const Color primaryDark = Color(
    0xFF1E3A5F,
  ); // Even darker blue for header backgrounds
  ...
  static const Color inputFillColor = Color(
    0xFFF7FAFC,
  ); // Very light grey for input fields
  ...
  static const Color lightBlueGradientStart = Color(
    0xFF81D4FA,
  ); // Lighter blue for header gradient
  static const Color blueGradientEnd = Color(
    0xFF2196F3,
  ); // Darker blue for header gradient
  static const Color lightBlueCard = Color(
    0xFFE3F2FD,
  ); // Light blue for diagnosis card
  static const Color lightOrangeCard = Color(
    0xFFFBE9E7,
  ); // Light red/orange for diagnosis card
  ...
  static const MaterialColor primaryMaterialColor =
      MaterialColor(0xFF007BFF, <int, Color>{
        50: Color(0xFFE0F2FF),
